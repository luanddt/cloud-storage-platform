...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1 overflow-auto", className)}
      {...props}
    />
  )
}
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("body-1 text-muted-foreground line-clamp-1", className)}
      {...props}
    />
  )
}
