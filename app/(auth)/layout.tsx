  ...
  return (
    <div className="flex min-h-screen">
      <section className="bg-primary p-10 xl:w-2/5 w-1/2 lg:flex-center hidden">
        <div className="max-w-107.5 flex flex-col items-center gap-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="body-1 text-primary-foreground">
      ...
      <section className="flex-1 p-10 max-lg:px-4 flex-center max-lg:justify-start flex-col gap-16">
        <Image
          src="/assets/icons/logo-full.svg"
          alt="StoreIt"
          width={200}
          height={72}
          className="h-18 lg:hidden"
        />
